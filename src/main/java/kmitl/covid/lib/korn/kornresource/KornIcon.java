...
public class KornIcon {
	public static void loadIcon() {
		...
		KornIcon.massiveFont = Font.loadFont(KornIcon.fontPath, KornIcon.iconMassive);
	...
	public static Label getIconMassive(String icon) {
		Label label = new Label(icon);
		label.setFont(KornIcon.massiveFont);
		return label;
	}
	...
	public static Font massiveFont;
	public static Font megaFont;
	public static Font bigFont;
	public static Font regularFont;
	public static Font smallFont;

	private static final int iconMassive = 72;
